...
Desktop PDF tools (QPDF / PyMuPDF / pypdf / Acrobat) report **2,812 pages** for this file and can open page 2462.

## Local convenience files (NOT Golden Trajectory sources)

Files in this folder (HTML viewers, PNG crops, small PDF extracts) are for local side-by-side checking only. They are **not** authoritative verification sources and must not appear in the Golden Trajectory.
